...
UPDATE channel SET channum=93, visible=1  WHERE sourceid="1" AND serviceid="15232"; #'Television X';
UPDATE channel SET channum=94, visible=1  WHERE sourceid="1" AND serviceid="8362"; #'ADULT smileTV2';
UPDATE channel SET channum=95, visible=1  WHERE sourceid="1" AND serviceid="22400"; #'ADULT smileTV3';
UPDATE channel SET channum=96, visible=1  WHERE sourceid="1" AND serviceid="27904"; #'ADULT Babestn';
UPDATE channel SET channum=97, visible=1  WHERE sourceid="1" AND serviceid="24256"; #'ADULT PARTY';
UPDATE channel SET channum=98, visible=1  WHERE sourceid="1" AND serviceid="24128"; #'ADULT Blue';
...
--DELETE FROM channel WHERE (freqid NOT IN  (32, 33, 36, 39, 41, 44, 47, 48, 51, 52, 56) AND freqid IS NOT NULL);

--Added to make eclipse sql editor fit all useful text in window
