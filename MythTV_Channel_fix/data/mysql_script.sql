...
UPDATE channel SET channum=1,  visible=1, xmltvid="yorkshire.bbc1.bbc.co.uk"            WHERE sourceid="1" AND serviceid="4170"; #'BBC ONE West Yprkshire';
...
UPDATE channel SET channum=115, visible=1, xmltvid="itv3.itv.co.uk"                          WHERE sourceid="1" AND serviceid="16048"; #'ITV3';
...
-- Removing weak channels

-- Go to http://www.ukfree.tv and search for your transmitter. Make a note of the UHF channels on which your freeview muxes are broadcast. These are NOT the same as the freeview channel numbers you select when watching TV! A single SQL statement like this will remove any channels which don't belong to your transmitter. For example, this deletes any channels not on the Sutton Coldfield transmitter:

-- DELETE FROM channel WHERE (freqid NOT IN (33, 35, 36, 39, 40, 42, 43, 45, 46, 51) AND freqid IS NOT NULL);
